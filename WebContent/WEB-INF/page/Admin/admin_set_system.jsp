...
<div class="horizatal_center1200" style="margin-top:60px">

<form class="exam-form form-horizontal horizatal_center600" style="padding-left:160px">
	<h4 style="margin-left:30px">修改系统配置</h4>
