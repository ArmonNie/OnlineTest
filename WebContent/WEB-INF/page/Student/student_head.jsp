...
<!-- <a class="dropdown-toggle" role="button" aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"> -->
				<ul class="nav navbar-nav">
					<li><a href="LinkAction?index=<%= "2000" %>"><i class="glyphicon glyphicon-home glyphicon-white"></i>首页</a></li>
					<li><a href="LinkAction?index=<%= "2001" %>"><i class="glyphicon glyphicon-cog glyphicon-white"></i>查看提交</a></li>
				</ul>
				<ul class="nav navbar-nav pull-right">
					<li><a href="LinkAction?index=<%= "0000" %>"><i class="glyphicon glyphicon-home glyphicon-white"></i>欢迎，<%= msession.getAttribute("username") %></a></li>
				</ul>
