		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
								<%
									...
									System.out.print(msession.getAttribute("enusername"));
									System.out.print("test");
									ORMTool ormtool = new ORMTool();
									ormtool.initSession();
									String hql = "select s.uploadFileName,s.uploadFileDate from Student s where s.studentname=?";
									Query query = ormtool.getQuery(hql);
									String en_inputUsername = msession.getAttribute("enusername").toString();
